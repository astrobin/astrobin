...
TITLE = _("AstroBin localization server")
...
<h2 class="title">Hi! On this website you can contribute to AstroBin by translating it to your language! If you don't see your language in the list, please write to astrobin@astrobin.com, thank you!</h2>
</div>""")
