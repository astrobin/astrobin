...
from astrobin_apps_equipment.templatetags.astrobin_apps_equipment_tags import unique_equipment_brand_listings_for_legacy_gear
...
class TestTagUniqueEquipmentBrandListings(TestCase):
    def test_no_listings(self):
        ...
        self.assertEqual(0, unique_equipment_brand_listings_for_legacy_gear(image, 'us').count())
    ...
    def test_with_gear_and_listing_in_no_country(self):
        ...
        self.assertEqual(1, unique_equipment_brand_listings_for_legacy_gear(image, 'us').count())
    ...
    def test_with_gear_and_two_unique_listings_on_same_gear_in_right_country(self):
        ...
        self.assertEqual(2, unique_equipment_brand_listings_for_legacy_gear(image, 'us').count())
