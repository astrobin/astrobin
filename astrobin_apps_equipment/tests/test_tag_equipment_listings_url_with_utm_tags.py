...
from astrobin_apps_equipment.templatetags.astrobin_apps_equipment_tags import equipment_brand_listing_url_with_tags
...
class TestTagEquipmentListingUrlWithUtmTags(TestCase):
    def test_simple_url(self):
        ...
        self.assertEqual(
            ...
            equipment_brand_listing_url_with_tags(listing, 'foo')
        )
    ...
    def test_url_with_conflicting_params(self):
        ...
        self.assertEqual(
            ...
            equipment_brand_listing_url_with_tags(listing, 'bar')
        )
