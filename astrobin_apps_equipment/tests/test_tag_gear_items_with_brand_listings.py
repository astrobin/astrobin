...
class TestTagGearItemsWithBrandListings(TestCase):
    def test_no_listings(self):
        image = Generators.image()

        self.assertEqual(0, legacy_gear_items_with_brand_listings(image, 'us').count())
    ...
    def test_with_gear_and_listing_in_no_country(self):
        ...
        self.assertEqual(1, legacy_gear_items_with_brand_listings(image, 'us').count())
