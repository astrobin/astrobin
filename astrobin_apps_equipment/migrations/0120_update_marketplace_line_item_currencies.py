# Generated by Django 2.2.24 on 2023-12-11 21:21
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                choices=[('AED', 'UAE Dirham'), ('AFN', 'Afghani'), ('ALL', 'Lek'), ('AMD', 'Armenian Dram'),
                         ...
                         ('CUC', 'Peso Convertible'), ('CUP', 'Cuban Peso'), ('CVE', 'Cabo Verde Escudo'),
                         ...
                         ('HRK', 'Kuna'), ('HTG', 'Gourde'), ('HUF', 'Forint'), ('IDR', 'Rupiah'),
                         ('ILS', 'New Israeli Sheqel'), ('INR', 'Indian Rupee'), ('IQD', 'Iraqi Dinar'),
                         ('IRR', 'Iranian Rial'), ('ISK', 'Iceland Krona'), ('JMD', 'Jamaican Dollar'),
                         ...
                         ('MXN', 'Mexican Peso'), ('MXV', 'Mexican Unidad de Inversion (UDI)'),
                         ('MYR', 'Malaysian Ringgit'), ('MZN', 'Mozambique Metical'), ('NAD', 'Namibia Dollar'),
                         ('NGN', 'Naira'), ('NIO', 'Cordoba Oro'), ('NOK', 'Norwegian Krone'),
                         ...
                         ('SGD', 'Singapore Dollar'), ('SHP', 'Saint Helena Pound'), ('SLE', 'Leone'), ('SLL', 'Leone'),
                         ...
                         ('UYW', 'Unidad Previsional'), ('UZS', 'Uzbekistan Sum'), ('VED', 'Bolívar Soberano'),
                         ...
                         ('XSU', 'Sucre'), ('XTS', 'Codes specifically reserved for testing purposes'),
                         ('XUA', 'ADB Unit of Account'),
                         ('XXX', 'The codes assigned for transactions where no currency is involved'),
                         ('YER', 'Yemeni Rial'), ('ZAR', 'Rand'), ('ZMW', 'Zambian Kwacha'),
                         ('ZWL', 'Zimbabwe Dollar')], max_length=3, null=True
            ),
        ),
    ]
