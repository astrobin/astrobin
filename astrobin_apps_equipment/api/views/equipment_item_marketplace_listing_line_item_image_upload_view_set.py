...
from astrobin_apps_equipment.api.serializers.equipment_item_marketplace_listing_line_item_image_upload_serializer import \
    EquipmentItemMarketplaceListingLineItemImageUploadSerializer
...
class EquipmentItemMarketplaceListingLineItemImageUploadViewSet(
    TusCreateMixin,
    TusPatchMixin,
    TusHeadMixin,
    TusTerminateMixin,
    ...
    serializer_class = EquipmentItemMarketplaceListingLineItemImageUploadSerializer
