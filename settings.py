...
IOTD_SUBMISSION_WINDOW_WEEKS = 1
IOTD_SUBMISSION_MAX_PER_DAY = 5

IOTD_REVIEW_WINDOW_WEEKS = 2
IOTD_REVIEW_MAX_PER_DAY = 5

IOTD_JUDGEMENT_WINDOW_WEEKS = 2
IOTD_JUDGEMENT_MAX_PER_DAY = 5
IOTD_JUDGEMENT_MAX_FUTURE_DAYS = 14
