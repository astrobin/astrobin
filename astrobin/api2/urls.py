...
from astrobin.api2.views.deepsky_equipment_preset_viewset import DeepSkyAcquisitionPresetViewSet
...
from astrobin.api2.views.solarsystem_equipment_preset_viewset import SolarSystemAcquisitionPresetViewSet
...
router.register(r'deepsky-acquisition-preset', DeepSkyAcquisitionPresetViewSet, basename='deepsky-acquisition-preset')
router.register(
    r'solarsystem-acquisition-preset',
    SolarSystemAcquisitionPresetViewSet,
    basename='solarsystem-acquisition-preset'
)
