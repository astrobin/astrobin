...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.moderator_decision'
        db.add_column('astrobin_image', 'moderator_decision',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Image.moderated_when'
        db.add_column('astrobin_image', 'moderated_when',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Image.moderated_by'
        db.add_column('astrobin_image', 'moderated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='images_moderated', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.moderator_decision'
        db.delete_column('astrobin_image', 'moderator_decision')

        # Deleting field 'Image.moderated_when'
        db.delete_column('astrobin_image', 'moderated_when')

        # Deleting field 'Image.moderated_by'
        db.delete_column('astrobin_image', 'moderated_by_id')
    ...
    models = {
        ...
        'astrobin.image': {
            ...
            'moderator_decision': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
