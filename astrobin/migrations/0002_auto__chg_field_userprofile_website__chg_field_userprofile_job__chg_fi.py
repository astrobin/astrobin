...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('astrobin_userprofile', 'website', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'UserProfile.job'
        db.alter_column('astrobin_userprofile', 'job', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'UserProfile.hobbies'
        db.alter_column('astrobin_userprofile', 'hobbies', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.website'
        db.alter_column('astrobin_userprofile', 'website', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'UserProfile.job'
        db.alter_column('astrobin_userprofile', 'job', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'UserProfile.hobbies'
        db.alter_column('astrobin_userprofile', 'hobbies', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
