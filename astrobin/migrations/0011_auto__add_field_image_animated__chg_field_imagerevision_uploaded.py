...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('astrobin_image', 'animated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'ImageRevision.uploaded'
        db.alter_column('astrobin_imagerevision', 'uploaded', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Deleting field 'Image.animated'
        db.delete_column('astrobin_image', 'animated')

        # Changing field 'ImageRevision.uploaded'
        db.alter_column('astrobin_imagerevision', 'uploaded', self.gf('django.db.models.fields.DateTimeField')())
