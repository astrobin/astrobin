...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GearHardMergeRedirect'
        db.create_table('astrobin_gearhardmergeredirect', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fro', self.gf('django.db.models.fields.IntegerField')()),
            ('to', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('astrobin', ['GearHardMergeRedirect'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GearHardMergeRedirect'
        db.delete_table('astrobin_gearhardmergeredirect')
