...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='delete_reason',
            field=models.CharField(choices=[('NOT_ACTIVE', 'I am no longer active in astrophotography'),
                                            ('DID_NOT_MEET_EXPECTATIONS', 'This website did not meet my expectations'),
                                            ('DOESNT_WORK', "Something on this website doesn't work for me"),
                                            ('TOO_EXPENSIVE', 'The paid subscriptions are too expensive'),
                                            ('PREFER_NOT_TO_SAY', 'I prefer not to say'), ('OTHER', 'Other')],
        ...
        migrations.AlterField(
            model_name='userprofile',
            name='timezone',
            field=models.CharField(blank=True, choices=[('Pacific/Midway', '(GMT-1100) Pacific/Midway'),
                                                        ...
                                                        ('GMT', '(GMT+0000) GMT'), ('UTC', '(GMT+0000) UTC'),
