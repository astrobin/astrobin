...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('astrobin_image', 'binning', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Image.scaling'
        db.add_column('astrobin_image', 'scaling', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True), keep_default=False)
    ...
    models = {
        ...
        'astrobin.image': {
            ...
            'binning': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'scaling': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
