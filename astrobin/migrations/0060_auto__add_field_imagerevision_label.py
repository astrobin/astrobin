...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageRevision.label'
        db.add_column('astrobin_imagerevision', 'label', self.gf('django.db.models.fields.CharField')(default='A', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageRevision.label'
        db.delete_column('astrobin_imagerevision', 'label')
    ...
    models = {
        ...
        'astrobin.imagerevision': {
            ...
            'is_solved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_stored': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'original_ext': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
            'uploaded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'w': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
