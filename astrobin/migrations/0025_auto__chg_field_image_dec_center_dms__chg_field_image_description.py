...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.dec_center_dms'
        db.alter_column('astrobin_image', 'dec_center_dms', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))

        # Changing field 'Image.description'
        db.alter_column('astrobin_image', 'description', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Image.dec_center_dms'
        db.alter_column('astrobin_image', 'dec_center_dms', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'Image.description'
        db.alter_column('astrobin_image', 'description', self.gf('django.db.models.fields.TextField')(default=''))
