...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GearMakeAutoRename'
        db.create_table('astrobin_gearmakeautorename', (
            ('rename_from', self.gf('django.db.models.fields.CharField')(max_length=128, primary_key=True)),
            ('rename_to', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('astrobin', ['GearMakeAutoRename'])


    def backwards(self, orm):
        
        # Deleting model 'GearMakeAutoRename'
        db.delete_table('astrobin_gearmakeautorename')
