...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.Image.objects.filter(
            models.Q(title = None) |
            models.Q(is_stored = False)).delete()
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 12, 36, 1, 754342)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 12, 36, 1, 757979)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 12, 36, 1, 757757)'}),
