...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ImageRevision.is_solved'
        db.delete_column('astrobin_imagerevision', 'is_solved')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ImageRevision.is_solved'
        db.add_column('astrobin_imagerevision', 'is_solved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 20, 9, 13, 34, 461763)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 20, 9, 13, 34, 495597)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 20, 9, 13, 34, 495404)'}),
