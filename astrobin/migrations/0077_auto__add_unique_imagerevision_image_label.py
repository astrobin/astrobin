...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ImageRevision', fields ['image', 'label']
        db.create_unique('astrobin_imagerevision', ['image_id', 'label'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ImageRevision', fields ['image', 'label']
        db.delete_unique('astrobin_imagerevision', ['image_id', 'label'])
