...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.exclude_from_competitions'
        db.add_column('astrobin_userprofile', 'exclude_from_competitions',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.exclude_from_competitions'
        db.delete_column('astrobin_userprofile', 'exclude_from_competitions')
