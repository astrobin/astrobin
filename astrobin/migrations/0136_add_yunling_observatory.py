# Generated by Django 2.2.24 on 2022-01-19 10:36
...
class Migration(migrations.Migration):
    dependencies = [
        ('astrobin', '0135_remove_userprofile_default_watermark_options'),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                choices=[(None, '---------'), ('OWN', 'Non-commercial independent facility'), (None, '---------'),
                         ...
                         ('TELI', 'Telescope Live'), ('YUNLING', 'Yunling Observatory'),
