...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.dec_center_hms'
        db.add_column('astrobin_image', 'dec_center_hms', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Image.dec_center_hms'
        db.delete_column('astrobin_image', 'dec_center_hms')
    ...
    models = {
        ...
        'astrobin.image': {
            ...
            'binning': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'dec_center_hms': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
