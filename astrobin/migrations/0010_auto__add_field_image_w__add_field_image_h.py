...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.w'
        db.add_column('astrobin_image', 'w', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Image.h'
        db.add_column('astrobin_image', 'h', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.w'
        db.delete_column('astrobin_image', 'w')

        # Deleting field 'Image.h'
        db.delete_column('astrobin_image', 'h')
