...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeepSky_Acquisition.binning'
        db.add_column('astrobin_deepsky_acquisition', 'binning', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeepSky_Acquisition.binning'
        db.delete_column('astrobin_deepsky_acquisition', 'binning')
