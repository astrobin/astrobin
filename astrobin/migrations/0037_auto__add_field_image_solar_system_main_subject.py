...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.solar_system_main_subject'
        db.add_column('astrobin_image', 'solar_system_main_subject', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.solar_system_main_subject'
        db.delete_column('astrobin_image', 'solar_system_main_subject')
