...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FocalReducer.ratio'
        db.delete_column('astrobin_focalreducer', 'ratio')


    def backwards(self, orm):
        
        # Adding field 'FocalReducer.ratio'
        db.add_column('astrobin_focalreducer', 'ratio', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2, blank=True), keep_default=False)
