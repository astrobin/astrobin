...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommercialGear.tagline'
        db.add_column('astrobin_commercialgear', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Changing field 'CommercialGear.link'
        db.alter_column('astrobin_commercialgear', 'link', self.gf('django.db.models.fields.URLField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Deleting field 'CommercialGear.tagline'
        db.delete_column('astrobin_commercialgear', 'tagline')

        # Changing field 'CommercialGear.link'
        db.alter_column('astrobin_commercialgear', 'link', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
