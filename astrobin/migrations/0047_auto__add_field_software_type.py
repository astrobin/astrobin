...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Software.type'
        db.add_column('astrobin_software', 'type', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Software.type'
        db.delete_column('astrobin_software', 'type')
