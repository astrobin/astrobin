...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='language',
            field=models.CharField(blank=True, choices=[('en', 'English (US)'), ('en-GB', 'English (GB)'), ('it', 'Italian'), ('es', 'Spanish'), ('fr', 'French'), ('fi', 'Finnish'), ('de', 'German'), ('nl', 'Dutch'), ('tr', 'Turkish'), ('sq', 'Albanian'), ('pl', 'Polish'), ('pt-BR', 'Brazilian Portuguese'), ('el', 'Greek'), ('ru', 'Russian'), ('ar', 'Arabic'), ('ja', 'Japanese')], max_length=8, null=True, verbose_name='Language'),
        ),
    ]
