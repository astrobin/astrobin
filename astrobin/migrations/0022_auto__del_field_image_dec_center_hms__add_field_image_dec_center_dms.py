...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('astrobin_image', 'dec_center_dms', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'astrobin.image': {
            ...
            'binning': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'dec_center_dms': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
