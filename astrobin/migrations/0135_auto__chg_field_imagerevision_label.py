...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'astrobin_imagerevision', 'label', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'ImageRevision.label'
        db.alter_column(u'astrobin_imagerevision', 'label', self.gf('django.db.models.fields.CharField')(max_length=1))
