...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommercialGearProperty'
        db.create_table('astrobin_commercialgearproperty', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='properties', to=orm['astrobin.CommercialGear'])),
        ...
        db.send_create_signal('astrobin', ['CommercialGearProperty'])

        # Adding model 'CommercialGear'
        db.create_table('astrobin_commercialgear', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('producer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commercial_gear', to=orm['auth.User'])),
            ('proper_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='featured_gear', null=True, to=orm['astrobin.Image'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('astrobin', ['CommercialGear'])

        # Adding field 'Gear.commercial'
        db.add_column('astrobin_gear', 'commercial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.CommercialGear'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'CommercialGearProperty'
        db.delete_table('astrobin_commercialgearproperty')

        # Deleting model 'CommercialGear'
        db.delete_table('astrobin_commercialgear')

        # Deleting field 'Gear.commercial'
        db.delete_column('astrobin_gear', 'commercial_id')
