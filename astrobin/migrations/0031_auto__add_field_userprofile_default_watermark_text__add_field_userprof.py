...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.default_watermark_full_size'
        db.add_column('astrobin_userprofile', 'default_watermark_full_size', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.default_watermark_normal_size'
        db.add_column('astrobin_userprofile', 'default_watermark_normal_size', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.default_watermark_full_size'
        db.delete_column('astrobin_userprofile', 'default_watermark_full_size')

        # Deleting field 'UserProfile.default_watermark_normal_size'
        db.delete_column('astrobin_userprofile', 'default_watermark_normal_size')
    ...
    models = {
        ...
        'astrobin.image': {
            ...
            'watermark_full_size': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'watermark_normal_size': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'astrobin.userprofile': {
            ...
            'default_watermark_full_size': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'default_watermark_normal_size': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
