...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeepSky_Acquisition.advanced'
        db.add_column('astrobin_deepsky_acquisition', 'advanced', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeepSky_Acquisition.advanced'
        db.delete_column('astrobin_deepsky_acquisition', 'advanced')
