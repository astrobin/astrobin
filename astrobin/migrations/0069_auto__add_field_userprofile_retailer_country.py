...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.retailer_country'
        db.add_column('astrobin_userprofile', 'retailer_country', self.gf('astrobin.fields.CountryField')(max_length=2, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.retailer_country'
        db.delete_column('astrobin_userprofile', 'retailer_country')
