...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.subject_type'
        db.add_column('astrobin_image', 'subject_type', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.subject_type'
        db.delete_column('astrobin_image', 'subject_type')
