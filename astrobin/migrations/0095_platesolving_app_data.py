...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for i in orm['astrobin.Image'].objects.filter(is_solved = True):
            s = orm['astrobin_apps_platesolving.Solution']()

            s.ra_center_hms = i.ra_center_hms
            s.dec_center_dms = i.dec_center_dms
            s.pixscale = i.pixscale
            s.orientation = i.orientation
            s.fieldw = i.fieldw
            s.fieldh = i.fieldh
            s.fieldunits = i.fieldunits
    ...
    def backwards(self, orm):
        for s in orm['astrobin_apps_platesolving.Solution'].objects.all():
            ...
            i.ra_center_hms = s.ra_center_hms
            i.dec_center_dms = s.dec_center_dms
            i.pixscale = s.pixscale
            i.orientation = s.orientation
            i.fieldw = s.fieldw
            i.fieldh = s.fieldh
            i.fieldunits = s.fieldunits
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 20, 6, 25, 214842)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 20, 6, 25, 215576)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 20, 6, 25, 215505)'}),
