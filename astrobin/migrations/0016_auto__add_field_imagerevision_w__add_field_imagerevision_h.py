...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageRevision.w'
        db.add_column('astrobin_imagerevision', 'w', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ImageRevision.h'
        db.add_column('astrobin_imagerevision', 'h', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageRevision.w'
        db.delete_column('astrobin_imagerevision', 'w')

        # Deleting field 'ImageRevision.h'
        db.delete_column('astrobin_imagerevision', 'h')
