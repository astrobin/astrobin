...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GearComment'
        db.create_table('astrobin_gearcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gear', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Gear'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['astrobin.GearComment'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('astrobin', ['GearComment'])

        # Adding model 'GearUserInfo'
        db.create_table('astrobin_gearuserinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gear', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Gear'])),
        ...
        db.send_create_signal('astrobin', ['GearUserInfo'])

        # Adding unique constraint on 'GearUserInfo', fields ['gear', 'user']
        db.create_unique('astrobin_gearuserinfo', ['gear_id', 'user_id'])

        # Adding field 'Gear.updated'
        db.add_column('astrobin_gear', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)

        # Adding field 'Gear.moderator_fixed'
        db.add_column('astrobin_gear', 'moderator_fixed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'GearUserInfo', fields ['gear', 'user']
        db.delete_unique('astrobin_gearuserinfo', ['gear_id', 'user_id'])

        # Deleting model 'GearComment'
        db.delete_table('astrobin_gearcomment')

        # Deleting model 'GearUserInfo'
        db.delete_table('astrobin_gearuserinfo')

        # Deleting field 'Gear.updated'
        db.delete_column('astrobin_gear', 'updated')

        # Deleting field 'Gear.moderator_fixed'
        db.delete_column('astrobin_gear', 'moderator_fixed')
