# Generated by Django 2.2.24 on 2023-05-22 09:21
...
class Migration(migrations.Migration):
    dependencies = [
        ('astrobin', '0169_add_atlaskies_observatory'),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                choices=[('REFR ACHRO', 'Refractor: achromatic'), ('REFR SEMI-APO', 'Refractor: semi-apochromatic'),
                         ...
                         ('REFL GREGORIAN', 'Reflector: Gregorian'), ('REFL HERSCHELLIAN', 'Reflector: Herschellian'),
                         ...
                         ('CATA MAKSUTOV-NEWTONIAN', 'Catadioptric: Maksutov-Newtonian'),
                         ...
                         ('CAMERA LENS', 'Camera lens'), ('BINOCULARS', 'Binoculars')], max_length=64, null=True,
                verbose_name='Type'
            ),
        ),
    ]
