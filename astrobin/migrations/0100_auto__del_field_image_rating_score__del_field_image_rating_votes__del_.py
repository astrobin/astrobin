...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Image.rating_score'
        db.delete_column('astrobin_image', 'rating_score')

        # Deleting field 'Image.rating_votes'
        db.delete_column('astrobin_image', 'rating_votes')

        # Deleting field 'Image.allow_rating'
        db.delete_column('astrobin_image', 'allow_rating')

        # Deleting field 'UserProfile.optout_rating'
        db.delete_column('astrobin_userprofile', 'optout_rating')

        # Deleting field 'UserProfile.suspended_from_voting'
        db.delete_column('astrobin_userprofile', 'suspended_from_voting')


    def backwards(self, orm):
        
        # Adding field 'Image.rating_score'
        db.add_column('astrobin_image', 'rating_score', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Image.rating_votes'
        db.add_column('astrobin_image', 'rating_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Image.allow_rating'
        db.add_column('astrobin_image', 'allow_rating', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.optout_rating'
        db.add_column('astrobin_userprofile', 'optout_rating', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.suspended_from_voting'
        db.add_column('astrobin_userprofile', 'suspended_from_voting', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 17, 18, 52, 12, 718318)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 17, 18, 52, 12, 748809)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 17, 18, 52, 12, 748654)'}),
