...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.default_frontpage_section'
        db.add_column('astrobin_userprofile', 'default_frontpage_section', self.gf('django.db.models.fields.CharField')(default='personal', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.default_frontpage_section'
        db.delete_column('astrobin_userprofile', 'default_frontpage_section')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 3, 10, 42, 10, 357495)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 3, 10, 42, 10, 341282)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 3, 10, 42, 10, 341207)'}),
