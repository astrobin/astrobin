...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.watermark_size'
        db.add_column('astrobin_image', 'watermark_size',
                      self.gf('django.db.models.fields.CharField')(default='M', max_length=1),
                      keep_default=False)

        # Adding field 'UserProfile.default_watermark_size'
        db.add_column('astrobin_userprofile', 'default_watermark_size',
                      self.gf('django.db.models.fields.CharField')(default='M', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.watermark_size'
        db.delete_column('astrobin_image', 'watermark_size')

        # Deleting field 'UserProfile.default_watermark_size'
        db.delete_column('astrobin_userprofile', 'default_watermark_size')
    ...
    models = {
        ...
        'astrobin.collection': {
            ...
            'cover': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['astrobin.Image']", 'null': 'True', 'blank': 'True'}),
