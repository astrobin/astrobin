...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImageOfTheDayCandidate'
        db.create_table('astrobin_imageofthedaycandidate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='image_of_the_day_candidate', to=orm['astrobin.Image'])),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('astrobin', ['ImageOfTheDayCandidate'])


    def backwards(self, orm):
        
        # Deleting model 'ImageOfTheDayCandidate'
        db.delete_table('astrobin_imageofthedaycandidate')
