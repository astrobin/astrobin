...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommercialGear.tagline_pt_BR'
        db.add_column('astrobin_commercialgear', 'tagline_pt_BR', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'CommercialGear.tagline_el'
        db.add_column('astrobin_commercialgear', 'tagline_el', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'CommercialGear.description_pt_BR'
        db.add_column('astrobin_commercialgear', 'description_pt_BR', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'CommercialGear.description_el'
        db.add_column('astrobin_commercialgear', 'description_el', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CommercialGear.tagline_pt_BR'
        db.delete_column('astrobin_commercialgear', 'tagline_pt_BR')

        # Deleting field 'CommercialGear.tagline_el'
        db.delete_column('astrobin_commercialgear', 'tagline_el')

        # Deleting field 'CommercialGear.description_pt_BR'
        db.delete_column('astrobin_commercialgear', 'description_pt_BR')

        # Deleting field 'CommercialGear.description_el'
        db.delete_column('astrobin_commercialgear', 'description_el')
