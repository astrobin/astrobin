...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommercialGear.tagline_ru'
        db.add_column('astrobin_commercialgear', 'tagline_ru', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'CommercialGear.description_ru'
        db.add_column('astrobin_commercialgear', 'description_ru', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


        # Adding field 'CommercialGear.tagline_ar'
        db.add_column('astrobin_commercialgear', 'tagline_ar', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'CommercialGear.description_ar'
        db.add_column('astrobin_commercialgear', 'description_ar', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'CommercialGear.tagline_ja'
        db.add_column('astrobin_commercialgear', 'tagline_ja', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'CommercialGear.description_ja'
        db.add_column('astrobin_commercialgear', 'description_ja', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'CommercialGear.tagline_ru'
        db.delete_column('astrobin_commercialgear', 'tagline_ru')

        # Deleting field 'CommercialGear.description_ru'
        db.delete_column('astrobin_commercialgear', 'description_ru')

        # Deleting field 'CommercialGear.tagline_ar'
        db.delete_column('astrobin_commercialgear', 'tagline_ar')

        # Deleting field 'CommercialGear.description_ar'
        db.delete_column('astrobin_commercialgear', 'description_ar')

        # Deleting field 'CommercialGear.tagline_ja'
        db.delete_column('astrobin_commercialgear', 'tagline_ja')

        # Deleting field 'CommercialGear.description_ja'
        db.delete_column('astrobin_commercialgear', 'description_ja')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 29, 11, 39, 41, 223418)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 29, 11, 39, 41, 226734)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 29, 11, 39, 41, 226668)'}),
