...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        Group.objects.filter(name = "Producers").delete()
        Group.objects.filter(name = "Retailers").delete()
        Group.objects.filter(name = "Paying").delete()

        Group.objects.filter(name = "affiliate-1").delete()
        Group.objects.filter(name = "affiliate-10").delete()
        Group.objects.filter(name = "affiliate-50").delete()
        Group.objects.filter(name = "affiliate-100").delete()
        Group.objects.filter(name = "affiliate-inf").delete()

        Group.objects.filter(name = "retailer-affiliate-1").delete()
        Group.objects.filter(name = "retailer-affiliate-10").delete()
        Group.objects.filter(name = "retailer-affiliate-50").delete()
        Group.objects.filter(name = "retailer-affiliate-100").delete()
        Group.objects.filter(name = "retailer-affiliate-inf").delete()

        Group.objects.filter(name = "everyone").delete()

        Group.objects.filter(name = "rawdata-meteor").delete()
        Group.objects.filter(name = "rawdata-luna").delete()
        Group.objects.filter(name = "rawdata-sol").delete()
        Group.objects.filter(name = "rawdata-galaxia").delete()

        Group.objects.filter(name = "astrobin-donor-coffee-monthly").delete()
        Group.objects.filter(name = "astrobin-donor-snack-monthly").delete()
        Group.objects.filter(name = "astrobin-donor-pizza-monthly").delete()
        Group.objects.filter(name = "astrobin-donor-movie-monthly").delete()
        Group.objects.filter(name = "astrobin-donor-dinner-monthly").delete()

        Group.objects.filter(name = "astrobin-donor-coffee-yearly").delete()
        Group.objects.filter(name = "astrobin-donor-snack-yearly").delete()
        Group.objects.filter(name = "astrobin-donor-pizza-yearly").delete()
        Group.objects.filter(name = "astrobin-donor-movie-yearly").delete()
        Group.objects.filter(name = "astrobin-donor-dinner-yearly").delete()

        Group.objects.filter(name = "IOTD_Staff").delete()
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 9, 2, 30, 536219)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 9, 2, 30, 541751)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 9, 2, 30, 541673)'}),
