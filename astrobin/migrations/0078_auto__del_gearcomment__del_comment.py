...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('astrobin_gearcomment', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(related_name='children', null=True, to=orm['astrobin.GearComment'], blank=True)),
        ...
        db.create_table('astrobin_comment', (
            ...
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(related_name='children', null=True, to=orm['astrobin.Comment'], blank=True)),
