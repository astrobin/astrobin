...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Telescope.aperture'
        db.alter_column('astrobin_telescope', 'aperture', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

        # Changing field 'Telescope.focal_length'
        db.alter_column('astrobin_telescope', 'focal_length', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'Telescope.aperture'
        db.alter_column('astrobin_telescope', 'aperture', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Telescope.focal_length'
        db.alter_column('astrobin_telescope', 'focal_length', self.gf('django.db.models.fields.IntegerField')(null=True))
