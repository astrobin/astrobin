...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImageOfTheDay'
        db.create_table('astrobin_imageoftheday', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='image_of_the_day', to=orm['astrobin.Image'])),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('astrobin', ['ImageOfTheDay'])


    def backwards(self, orm):
        
        # Deleting model 'ImageOfTheDay'
        db.delete_table('astrobin_imageoftheday')
