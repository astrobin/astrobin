...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Image.is_default'
        db.delete_column('astrobin_image', 'is_default')

        # Adding field 'Image.is_final'
        db.add_column('astrobin_image', 'is_final', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'ImageRevision.is_default'
        db.delete_column('astrobin_imagerevision', 'is_default')

        # Adding field 'ImageRevision.is_final'
        db.add_column('astrobin_imagerevision', 'is_final', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Image.is_default'
        db.add_column('astrobin_image', 'is_default', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Image.is_final'
        db.delete_column('astrobin_image', 'is_final')

        # Adding field 'ImageRevision.is_default'
        db.add_column('astrobin_imagerevision', 'is_default', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'ImageRevision.is_final'
        db.delete_column('astrobin_imagerevision', 'is_final')
