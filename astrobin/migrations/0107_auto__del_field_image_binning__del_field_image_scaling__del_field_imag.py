...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Image.binning'
        db.delete_column('astrobin_image', 'binning')

        # Deleting field 'Image.scaling'
        db.delete_column('astrobin_image', 'scaling')

        # Deleting field 'Image.presolve_information'
        db.delete_column('astrobin_image', 'presolve_information')

        # Deleting field 'Image.pixel_size'
        db.delete_column('astrobin_image', 'pixel_size')

        # Deleting field 'Image.focal_length'
        db.delete_column('astrobin_image', 'focal_length')


    def backwards(self, orm):
        
        # Adding field 'Image.binning'
        db.add_column('astrobin_image', 'binning', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True), keep_default=False)

        # Adding field 'Image.scaling'
        db.add_column('astrobin_image', 'scaling', self.gf('django.db.models.fields.DecimalField')(default=100, null=True, max_digits=6, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Image.presolve_information'
        db.add_column('astrobin_image', 'presolve_information', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Image.pixel_size'
        db.add_column('astrobin_image', 'pixel_size', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Image.focal_length'
        db.add_column('astrobin_image', 'focal_length', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 22, 11, 24, 11, 609312)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 22, 11, 24, 11, 615002)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 22, 11, 24, 11, 614926)'}),
