...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.watermark_text'
        db.add_column('astrobin_image', 'watermark_text', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Image.watermark'
        db.add_column('astrobin_image', 'watermark', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Image.watermark_position'
        db.add_column('astrobin_image', 'watermark_position', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Image.watermark_opacity'
        db.add_column('astrobin_image', 'watermark_opacity', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)

        # Adding field 'UserProfile.default_watermark_text'
        db.add_column('astrobin_userprofile', 'default_watermark_text', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.default_watermark'
        db.add_column('astrobin_userprofile', 'default_watermark', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.default_watermark_position'
        db.add_column('astrobin_userprofile', 'default_watermark_position', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'UserProfile.default_watermark_opacity'
        db.add_column('astrobin_userprofile', 'default_watermark_opacity', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.watermark_text'
        db.delete_column('astrobin_image', 'watermark_text')

        # Deleting field 'Image.watermark'
        db.delete_column('astrobin_image', 'watermark')

        # Deleting field 'Image.watermark_position'
        db.delete_column('astrobin_image', 'watermark_position')

        # Deleting field 'Image.watermark_opacity'
        db.delete_column('astrobin_image', 'watermark_opacity')

        # Deleting field 'UserProfile.default_watermark_text'
        db.delete_column('astrobin_userprofile', 'default_watermark_text')

        # Deleting field 'UserProfile.default_watermark'
        db.delete_column('astrobin_userprofile', 'default_watermark')

        # Deleting field 'UserProfile.default_watermark_position'
        db.delete_column('astrobin_userprofile', 'default_watermark_position')

        # Deleting field 'UserProfile.default_watermark_opacity'
        db.delete_column('astrobin_userprofile', 'default_watermark_opacity')
