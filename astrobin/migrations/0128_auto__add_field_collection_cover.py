...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.cover'
        db.add_column('astrobin_collection', 'cover',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Image'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collection.cover'
        db.delete_column('astrobin_collection', 'cover_id')
    ...
    models = {
        ...
        'astrobin.collection': {
            ...
            'cover': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['astrobin.Image']", 'null': 'True'}),
