...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field follows_gear on 'UserProfile'
        db.delete_table('astrobin_userprofile_follows_gear')

        # Removing M2M table for field follows_subjects on 'UserProfile'
        db.delete_table('astrobin_userprofile_follows_subjects')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field follows_gear on 'UserProfile'
        db.create_table('astrobin_userprofile_follows_gear', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['astrobin.userprofile'], null=False)),
            ('gear', models.ForeignKey(orm['astrobin.gear'], null=False))
        ))
        db.create_unique('astrobin_userprofile_follows_gear', ['userprofile_id', 'gear_id'])

        # Adding M2M table for field follows_subjects on 'UserProfile'
        db.create_table('astrobin_userprofile_follows_subjects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['astrobin.userprofile'], null=False)),
            ('subject', models.ForeignKey(orm['astrobin.subject'], null=False))
        ))
        db.create_unique('astrobin_userprofile_follows_subjects', ['userprofile_id', 'subject_id'])
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 20, 19, 55, 58, 952378)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 20, 19, 55, 58, 933968)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 20, 19, 55, 58, 933893)'}),
