...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Favorite', fields ['image', 'user']
        db.delete_unique('astrobin_favorite', ['image_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Favorite', fields ['image', 'user']
        db.create_unique('astrobin_favorite', ['image_id', 'user_id'])
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 19, 33, 27, 248031)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 19, 33, 27, 226808)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 19, 33, 27, 226731)'}),
