...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'App'
        db.create_table('astrobin_app', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('registrar', self.gf('django.db.models.fields.related.ForeignKey')(related_name='app_api_key', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('key', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('secret', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('astrobin', ['App'])

        # Adding model 'AppApiKeyRequest'
        db.create_table('astrobin_appapikeyrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('registrar', self.gf('django.db.models.fields.related.ForeignKey')(related_name='app_api_key_request', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('astrobin', ['AppApiKeyRequest'])


    def backwards(self, orm):
        
        # Deleting model 'App'
        db.delete_table('astrobin_app')

        # Deleting model 'AppApiKeyRequest'
        db.delete_table('astrobin_appapikeyrequest')
