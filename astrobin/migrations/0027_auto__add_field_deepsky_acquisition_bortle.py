...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeepSky_Acquisition.bortle'
        db.add_column('astrobin_deepsky_acquisition', 'bortle', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeepSky_Acquisition.bortle'
        db.delete_column('astrobin_deepsky_acquisition', 'bortle')
