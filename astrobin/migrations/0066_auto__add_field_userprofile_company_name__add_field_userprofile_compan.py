...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('astrobin_userprofile', 'company_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.company_description'
        db.add_column('astrobin_userprofile', 'company_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.company_website'
        db.add_column('astrobin_userprofile', 'company_website', self.gf('django.db.models.fields.URLField')(max_length=512, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.company_name'
        db.delete_column('astrobin_userprofile', 'company_name')

        # Deleting field 'UserProfile.company_description'
        db.delete_column('astrobin_userprofile', 'company_description')

        # Deleting field 'UserProfile.company_website'
        db.delete_column('astrobin_userprofile', 'company_website')
