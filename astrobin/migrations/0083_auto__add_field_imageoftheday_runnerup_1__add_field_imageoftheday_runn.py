...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageOfTheDay.runnerup_1'
        db.add_column('astrobin_imageoftheday', 'runnerup_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='iotd_runnerup_1', null=True, to=orm['astrobin.Image']), keep_default=False)

        # Adding field 'ImageOfTheDay.runnerup_2'
        db.add_column('astrobin_imageoftheday', 'runnerup_2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='iotd_runnerup_2', null=True, to=orm['astrobin.Image']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageOfTheDay.runnerup_1'
        db.delete_column('astrobin_imageoftheday', 'runnerup_1_id')

        # Deleting field 'ImageOfTheDay.runnerup_2'
        db.delete_column('astrobin_imageoftheday', 'runnerup_2_id')
