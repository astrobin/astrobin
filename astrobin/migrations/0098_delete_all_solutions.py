...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm['astrobin.image'].objects.all().update(solution = None)
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 19, 27, 54, 88206)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 19, 27, 54, 82567)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 19, 27, 54, 82329)'}),
