...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RetailedGear.proper_make'
        db.delete_column('astrobin_retailedgear', 'proper_make')

        # Deleting field 'RetailedGear.proper_name'
        db.delete_column('astrobin_retailedgear', 'proper_name')


    def backwards(self, orm):
        
        # Adding field 'RetailedGear.proper_make'
        db.add_column('astrobin_retailedgear', 'proper_make', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'RetailedGear.proper_name'
        db.add_column('astrobin_retailedgear', 'proper_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'astrobin.gear': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'retailers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['astrobin.RetailedGear']", 'symmetrical': 'False'}),
