...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('astrobin_comment', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['astrobin.Comment'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('astrobin', ['Comment'])

        # Removing M2M table for field locations on 'UserProfile'
        db.delete_table('astrobin_userprofile_locations')

        # Deleting field 'Location.user_generated'
        db.delete_column('astrobin_location', 'user_generated')

        # Deleting field 'Location.longitude'
        db.delete_column('astrobin_location', 'longitude')

        # Deleting field 'Location.latitude'
        db.delete_column('astrobin_location', 'latitude')

        # Adding field 'Location.city'
        db.add_column('astrobin_location', 'city', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Adding field 'Location.state'
        db.add_column('astrobin_location', 'state', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Location.country'
        db.add_column('astrobin_location', 'country', self.gf('astrobin.fields.CountryField')(max_length=2, null=True), keep_default=False)

        # Adding field 'Location.lat_deg'
        db.add_column('astrobin_location', 'lat_deg', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Location.lat_min'
        db.add_column('astrobin_location', 'lat_min', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Location.lat_sec'
        db.add_column('astrobin_location', 'lat_sec', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Location.lon_deg'
        db.add_column('astrobin_location', 'lon_deg', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Location.lon_min'
        db.add_column('astrobin_location', 'lon_min', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Location.lon_sec'
        db.add_column('astrobin_location', 'lon_sec', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Location.user'
        db.add_column('astrobin_location', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.UserProfile'], null=True), keep_default=False)

        # Changing field 'Location.name'
        db.alter_column('astrobin_location', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('astrobin_comment')
        ...
        # Adding field 'Location.user_generated'
        db.add_column('astrobin_location', 'user_generated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Location.longitude'
        db.add_column('astrobin_location', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4, blank=True), keep_default=False)

        # Adding field 'Location.latitude'
        db.add_column('astrobin_location', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4, blank=True), keep_default=False)

        # Deleting field 'Location.city'
        db.delete_column('astrobin_location', 'city')

        # Deleting field 'Location.state'
        db.delete_column('astrobin_location', 'state')

        # Deleting field 'Location.country'
        db.delete_column('astrobin_location', 'country')

        # Deleting field 'Location.lat_deg'
        db.delete_column('astrobin_location', 'lat_deg')

        # Deleting field 'Location.lat_min'
        db.delete_column('astrobin_location', 'lat_min')

        # Deleting field 'Location.lat_sec'
        db.delete_column('astrobin_location', 'lat_sec')

        # Deleting field 'Location.lon_deg'
        db.delete_column('astrobin_location', 'lon_deg')

        # Deleting field 'Location.lon_min'
        db.delete_column('astrobin_location', 'lon_min')

        # Deleting field 'Location.lon_sec'
        db.delete_column('astrobin_location', 'lon_sec')

        # Deleting field 'Location.user'
        db.delete_column('astrobin_location', 'user_id')

        # Changing field 'Location.name'
        db.alter_column('astrobin_location', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
