...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('astrobin_userprofile', 'signature')

        # Deleting field 'UserProfile.signature_html'
        db.delete_column('astrobin_userprofile', 'signature_html')

        # Deleting field 'UserProfile.show_signatures'
        db.delete_column('astrobin_userprofile', 'show_signatures')

        # Deleting field 'UserProfile.post_count'
        db.delete_column('astrobin_userprofile', 'post_count')

        # Deleting field 'UserProfile.autosubscribe'
        db.delete_column('astrobin_userprofile', 'autosubscribe')
