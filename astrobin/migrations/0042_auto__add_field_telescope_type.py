...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Telescope.type'
        db.add_column('astrobin_telescope', 'type', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Telescope.type'
        db.delete_column('astrobin_telescope', 'type')
