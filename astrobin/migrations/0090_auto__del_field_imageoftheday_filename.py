...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ImageOfTheDay.filename'
        db.delete_column('astrobin_imageoftheday', 'filename')


    def backwards(self, orm):
        
        # Adding field 'ImageOfTheDay.filename'
        db.add_column('astrobin_imageoftheday', 'filename', self.gf('django.db.models.fields.CharField')(max_length=64, null=True), keep_default=False)
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 21, 12, 9, 3, 334593)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 21, 12, 9, 3, 335565)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 21, 12, 9, 3, 335501)'}),
