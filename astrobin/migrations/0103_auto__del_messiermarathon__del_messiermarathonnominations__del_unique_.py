...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'MessierMarathonNominations', fields ['messier_number', 'image']
        db.delete_unique('astrobin_messiermarathonnominations', ['messier_number', 'image_id'])

        # Deleting model 'MessierMarathon'
        db.delete_table('astrobin_messiermarathon')

        # Deleting model 'MessierMarathonNominations'
        db.delete_table('astrobin_messiermarathonnominations')

        # Removing M2M table for field nominators on 'MessierMarathonNominations'
        db.delete_table('astrobin_messiermarathonnominations_nominators')


    def backwards(self, orm):
        
        # Adding model 'MessierMarathon'
        db.create_table('astrobin_messiermarathon', (
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Image'])),
            ('messier_number', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
        ))
        db.send_create_signal('astrobin', ['MessierMarathon'])

        # Adding model 'MessierMarathonNominations'
        db.create_table('astrobin_messiermarathonnominations', (
            ('messier_number', self.gf('django.db.models.fields.IntegerField')()),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Image'])),
            ('nominations', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('astrobin', ['MessierMarathonNominations'])

        # Adding M2M table for field nominators on 'MessierMarathonNominations'
        db.create_table('astrobin_messiermarathonnominations_nominators', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('messiermarathonnominations', models.ForeignKey(orm['astrobin.messiermarathonnominations'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('astrobin_messiermarathonnominations_nominators', ['messiermarathonnominations_id', 'user_id'])

        # Adding unique constraint on 'MessierMarathonNominations', fields ['messier_number', 'image']
        db.create_unique('astrobin_messiermarathonnominations', ['messier_number', 'image_id'])
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 19, 52, 21, 828399)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 19, 52, 21, 831654)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 19, 52, 21, 831449)'}),
