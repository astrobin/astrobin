...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SolarSystem_Acquisition.fps'
        db.alter_column('astrobin_solarsystem_acquisition', 'fps', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=5))


    def backwards(self, orm):
        
        # Changing field 'SolarSystem_Acquisition.fps'
        db.alter_column('astrobin_solarsystem_acquisition', 'fps', self.gf('django.db.models.fields.IntegerField')(null=True))
