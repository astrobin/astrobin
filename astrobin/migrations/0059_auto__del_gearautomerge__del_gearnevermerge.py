...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'GearAutoMerge'
        db.delete_table('astrobin_gearautomerge')

        # Deleting model 'GearNeverMerge'
        db.delete_table('astrobin_gearnevermerge')


    def backwards(self, orm):
        
        # Adding model 'GearAutoMerge'
        db.create_table('astrobin_gearautomerge', (
            ('make', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Gear'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('astrobin', ['GearAutoMerge'])

        # Adding model 'GearNeverMerge'
        db.create_table('astrobin_gearnevermerge', (
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Gear'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('astrobin', ['GearNeverMerge'])
