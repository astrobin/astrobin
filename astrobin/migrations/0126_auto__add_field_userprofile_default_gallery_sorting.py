...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.default_gallery_sorting'
        db.add_column('astrobin_userprofile', 'default_gallery_sorting',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.default_gallery_sorting'
        db.delete_column('astrobin_userprofile', 'default_gallery_sorting')
