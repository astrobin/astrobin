...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GearAssistedMerge.slave'
        db.add_column('astrobin_gearassistedmerge', 'slave', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assisted_slave', null=True, to=orm['astrobin.Gear']), keep_default=False)

        # Changing field 'GearAssistedMerge.master'
        db.alter_column('astrobin_gearassistedmerge', 'master_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['astrobin.Gear']))

        # Deleting field 'Gear.parent'
        db.delete_column('astrobin_gear', 'parent_id')

        # Deleting field 'Gear.assisted_merge'
        db.delete_column('astrobin_gear', 'assisted_merge_id')

        # Adding field 'Gear.master'
        db.add_column('astrobin_gear', 'master', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Gear'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GearAssistedMerge.slave'
        db.delete_column('astrobin_gearassistedmerge', 'slave_id')

        # Changing field 'GearAssistedMerge.master'
        db.alter_column('astrobin_gearassistedmerge', 'master_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['astrobin.Gear']))

        # Adding field 'Gear.parent'
        db.add_column('astrobin_gear', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Gear'], null=True), keep_default=False)

        # Adding field 'Gear.assisted_merge'
        db.add_column('astrobin_gear', 'assisted_merge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.GearAssistedMerge'], null=True), keep_default=False)

        # Deleting field 'Gear.master'
        db.delete_column('astrobin_gear', 'master_id')
