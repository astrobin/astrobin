...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='language',
            field=models.CharField(blank=True,
                                   choices=[('en', 'English (US)'), ('en-GB', 'English (GB)'), ('it', 'Italian'),
                                            ('es', 'Spanish'), ('fr', 'French'), ('fi', 'Finnish'),
                                            ('de', 'German'), ('nl', 'Dutch'), ('tr', 'Turkish'),
                                            ('sq', 'Albanian'), ('pl', 'Polish'), ('pt', 'Portuguese'),
                                            ('el', 'Greek'), ('ru', 'Russian'), ('ar', 'Arabic'),
                                            ('ja', 'Japanese')], max_length=8, null=True, verbose_name='Language'),
        ),
        migrations.AlterField(
            model_name='userprofile',
            name='timezone',
            field=models.CharField(blank=True, choices=[('Pacific/Midway', '(GMT-1100) Pacific/Midway'),
                                                        ...
                                                        '(GMT-0500) America/Bahia_Banderas'),
                                                        ...
                                                        ('Antarctica/Casey', '(GMT+0800) Antarctica/Casey'),
