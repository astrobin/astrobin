...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeepSky_Acquisition.saved_on'
        db.add_column('astrobin_deepsky_acquisition', 'saved_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeepSky_Acquisition.saved_on'
        db.delete_column('astrobin_deepsky_acquisition', 'saved_on')
