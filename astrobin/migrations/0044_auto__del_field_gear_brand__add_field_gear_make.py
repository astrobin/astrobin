...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('astrobin_gear', 'brand')

        # Adding field 'Gear.make'
        db.add_column('astrobin_gear', 'make', self.gf('django.db.models.fields.CharField')(max_length=128, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Gear.brand'
        db.add_column('astrobin_gear', 'brand', self.gf('django.db.models.fields.CharField')(max_length=128, null=True), keep_default=False)

        # Deleting field 'Gear.make'
        db.delete_column('astrobin_gear', 'make')
