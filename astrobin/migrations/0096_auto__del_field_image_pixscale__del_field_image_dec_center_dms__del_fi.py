...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Image.pixscale'
        db.delete_column('astrobin_image', 'pixscale')

        # Deleting field 'Image.dec_center_dms'
        db.delete_column('astrobin_image', 'dec_center_dms')

        # Deleting field 'Image.fieldw'
        db.delete_column('astrobin_image', 'fieldw')

        # Deleting field 'Image.fieldh'
        db.delete_column('astrobin_image', 'fieldh')

        # Deleting field 'Image.orientation'
        db.delete_column('astrobin_image', 'orientation')

        # Deleting field 'Image.fieldunits'
        db.delete_column('astrobin_image', 'fieldunits')

        # Deleting field 'Image.ra_center_hms'
        db.delete_column('astrobin_image', 'ra_center_hms')

        # Deleting field 'Image.is_solved'
        db.delete_column('astrobin_image', 'is_solved')


    def backwards(self, orm):
        
        # Adding field 'Image.pixscale'
        db.add_column('astrobin_image', 'pixscale', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=10, blank=True), keep_default=False)

        # Adding field 'Image.dec_center_dms'
        db.add_column('astrobin_image', 'dec_center_dms', self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True), keep_default=False)

        # Adding field 'Image.fieldw'
        db.add_column('astrobin_image', 'fieldw', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=10, blank=True), keep_default=False)

        # Adding field 'Image.fieldh'
        db.add_column('astrobin_image', 'fieldh', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=10, blank=True), keep_default=False)

        # Adding field 'Image.orientation'
        db.add_column('astrobin_image', 'orientation', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=10, blank=True), keep_default=False)

        # Adding field 'Image.fieldunits'
        db.add_column('astrobin_image', 'fieldunits', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)

        # Adding field 'Image.ra_center_hms'
        db.add_column('astrobin_image', 'ra_center_hms', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True), keep_default=False)

        # Adding field 'Image.is_solved'
        db.add_column('astrobin_image', 'is_solved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 20, 30, 0, 947348)'}),
        ...
        'astrobin.favorite': {
            'Meta': {'ordering': "('-created',)", 'unique_together': "(('image', 'user'),)", 'object_name': 'Favorite'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['astrobin.Image']"}),
        ...
        'astrobin.imageoftheday': {
            ...
            'runnerup_2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'iotd_runnerup_2'", 'null': 'True', 'to': "orm['astrobin.Image']"})
        },
        ...
        'astrobin.userprofile': {
            ...
            'optout_rating': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 20, 30, 0, 931197)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 20, 30, 0, 931118)'}),
