...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.seen_realname'
        db.add_column('astrobin_userprofile', 'seen_realname', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.seen_realname'
        db.delete_column('astrobin_userprofile', 'seen_realname')
