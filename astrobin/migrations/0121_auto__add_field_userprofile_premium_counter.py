...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.premium_counter'
        db.add_column('astrobin_userprofile', 'premium_counter',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.premium_counter'
        db.delete_column('astrobin_userprofile', 'premium_counter')
