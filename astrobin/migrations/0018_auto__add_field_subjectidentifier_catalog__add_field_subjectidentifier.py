...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubjectIdentifier.catalog'
        db.add_column('astrobin_subjectidentifier', 'catalog', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'SubjectIdentifier.name'
        db.add_column('astrobin_subjectidentifier', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)

        # Adding field 'Subject.catalog'
        db.add_column('astrobin_subject', 'catalog', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Subject.name'
        db.add_column('astrobin_subject', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubjectIdentifier.catalog'
        db.delete_column('astrobin_subjectidentifier', 'catalog')

        # Deleting field 'SubjectIdentifier.name'
        db.delete_column('astrobin_subjectidentifier', 'name')

        # Deleting field 'Subject.catalog'
        db.delete_column('astrobin_subject', 'catalog')

        # Deleting field 'Subject.name'
        db.delete_column('astrobin_subject', 'name')
