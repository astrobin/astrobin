...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('astrobin_image', 'license', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'UserProfile.default_license'
        db.add_column('astrobin_userprofile', 'default_license', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.license'
        db.delete_column('astrobin_image', 'license')

        # Deleting field 'UserProfile.default_license'
        db.delete_column('astrobin_userprofile', 'default_license')
