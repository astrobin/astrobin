...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommercialGear.proper_make'
        db.add_column('astrobin_commercialgear', 'proper_make', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CommercialGear.proper_make'
        db.delete_column('astrobin_commercialgear', 'proper_make')
