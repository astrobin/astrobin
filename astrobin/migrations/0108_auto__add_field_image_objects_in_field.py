...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.objects_in_field'
        db.add_column('astrobin_image', 'objects_in_field', self.gf('django.db.models.fields.CharField')(max_length=512, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.objects_in_field'
        db.delete_column('astrobin_image', 'objects_in_field')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 25, 10, 32, 31, 427387)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 25, 10, 32, 31, 425992)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 25, 10, 32, 31, 425887)'}),
