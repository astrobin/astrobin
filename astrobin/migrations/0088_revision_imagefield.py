...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for image in orm.ImageRevision.objects.filter(image_file = None):
    ...
    def backwards(self, orm):
        ...
        for image in orm.ImageRevision.object.filter(filename = None, original_ext = None):
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 12, 39, 57, 237810)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 12, 39, 57, 249780)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 12, 39, 57, 249550)'}),
