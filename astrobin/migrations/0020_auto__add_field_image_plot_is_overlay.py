...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.plot_is_overlay'
        db.add_column('astrobin_image', 'plot_is_overlay', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.plot_is_overlay'
        db.delete_column('astrobin_image', 'plot_is_overlay')
