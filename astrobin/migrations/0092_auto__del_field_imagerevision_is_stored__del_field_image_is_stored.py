...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ImageRevision.is_stored'
        db.delete_column('astrobin_imagerevision', 'is_stored')

        # Deleting field 'Image.is_stored'
        db.delete_column('astrobin_image', 'is_stored')


    def backwards(self, orm):
        
        # Adding field 'ImageRevision.is_stored'
        db.add_column('astrobin_imagerevision', 'is_stored', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Image.is_stored'
        db.add_column('astrobin_image', 'is_stored', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 24, 17, 40, 9, 835659)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 24, 17, 40, 9, 833412)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 24, 17, 40, 9, 833337)'}),
