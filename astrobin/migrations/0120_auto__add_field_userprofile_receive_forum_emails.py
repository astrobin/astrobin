...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.receive_forum_emails'
        db.add_column('astrobin_userprofile', 'receive_forum_emails',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.receive_forum_emails'
        db.delete_column('astrobin_userprofile', 'receive_forum_emails')
