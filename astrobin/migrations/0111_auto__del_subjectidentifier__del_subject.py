...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('astrobin_subjectidentifier', (
            ...
            ('catalog', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
        ...
        db.create_table('astrobin_subject', (
            ...
            ('mainId', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True)),
        ))
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 21, 35, 36, 903230)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 21, 35, 36, 905142)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 21, 35, 36, 905073)'}),
