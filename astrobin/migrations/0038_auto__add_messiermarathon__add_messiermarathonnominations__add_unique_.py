...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.link_to_fits'
        db.add_column('astrobin_image', 'link_to_fits', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Image.link_to_fits'
        db.delete_column('astrobin_image', 'link_to_fits')
