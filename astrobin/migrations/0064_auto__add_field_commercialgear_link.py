...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommercialGear.link'
        db.add_column('astrobin_commercialgear', 'link', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CommercialGear.link'
        db.delete_column('astrobin_commercialgear', 'link')
