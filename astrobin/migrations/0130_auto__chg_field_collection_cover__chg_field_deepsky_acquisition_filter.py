...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collection.cover'
        db.alter_column(u'astrobin_collection', 'cover_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Image'], null=True, on_delete=models.SET_NULL))

        # Changing field 'DeepSky_Acquisition.filter'
        db.alter_column(u'astrobin_deepsky_acquisition', 'filter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Filter'], null=True, on_delete=models.SET_NULL))

        # Changing field 'CommercialGear.image'
        db.alter_column(u'astrobin_commercialgear', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['astrobin.Image']))

        # Changing field 'Image.moderated_by'
        db.alter_column(u'astrobin_image', 'moderated_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'ImageOfTheDay.chosen_by'
        db.alter_column(u'astrobin_imageoftheday', 'chosen_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Collection.cover'
        db.alter_column(u'astrobin_collection', 'cover_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Image'], null=True))

        # Changing field 'DeepSky_Acquisition.filter'
        db.alter_column(u'astrobin_deepsky_acquisition', 'filter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Filter'], null=True))

        # Changing field 'CommercialGear.image'
        db.alter_column(u'astrobin_commercialgear', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['astrobin.Image']))

        # Changing field 'Image.moderated_by'
        db.alter_column(u'astrobin_image', 'moderated_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ImageOfTheDay.chosen_by'
        db.alter_column(u'astrobin_imageoftheday', 'chosen_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
