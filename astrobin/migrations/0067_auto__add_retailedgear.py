...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RetailedGear'
        db.create_table('astrobin_retailedgear', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('retailer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='retailed_gear', to=orm['auth.User'])),
            ('proper_make', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('proper_name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=512, null=True, blank=True)),
        ...
        db.send_create_signal('astrobin', ['RetailedGear'])


    def backwards(self, orm):
        
        # Deleting model 'RetailedGear'
        db.delete_table('astrobin_retailedgear')
