...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ImageRevision.filename'
        db.delete_column('astrobin_imagerevision', 'filename')

        # Deleting field 'ImageRevision.original_ext'
        db.delete_column('astrobin_imagerevision', 'original_ext')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ImageRevision.filename'
        raise RuntimeError("Cannot reverse this migration. 'ImageRevision.filename' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ImageRevision.original_ext'
        raise RuntimeError("Cannot reverse this migration. 'ImageRevision.original_ext' and its values cannot be restored.")
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 12, 42, 10, 425960)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 12, 42, 10, 422679)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 12, 42, 10, 422604)'}),
