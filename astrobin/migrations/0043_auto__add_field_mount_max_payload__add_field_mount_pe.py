...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mount.max_payload'
        db.add_column('astrobin_mount', 'max_payload', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2), keep_default=False)

        # Adding field 'Mount.pe'
        db.add_column('astrobin_mount', 'pe', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Mount.max_payload'
        db.delete_column('astrobin_mount', 'max_payload')

        # Deleting field 'Mount.pe'
        db.delete_column('astrobin_mount', 'pe')
