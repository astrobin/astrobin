...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GearAssistedMerge.cutoff'
        db.add_column('astrobin_gearassistedmerge', 'cutoff', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GearAssistedMerge.cutoff'
        db.delete_column('astrobin_gearassistedmerge', 'cutoff')
    ...
    models = {
        ...
        'astrobin.gearassistedmerge': {
            ...
            'cutoff': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
