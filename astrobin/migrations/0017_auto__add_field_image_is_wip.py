...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.is_wip'
        db.add_column('astrobin_image', 'is_wip', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.is_wip'
        db.delete_column('astrobin_image', 'is_wip')
