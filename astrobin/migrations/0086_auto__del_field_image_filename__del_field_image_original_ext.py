...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('astrobin_image', 'filename')

        # Deleting field 'Image.original_ext'
        db.delete_column('astrobin_image', 'original_ext')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Image.filename'
        raise RuntimeError("Cannot reverse this migration. 'Image.filename' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Image.original_ext'
        raise RuntimeError("Cannot reverse this migration. 'Image.original_ext' and its values cannot be restored.")
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 11, 40, 5, 857248)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 11, 40, 5, 862190)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 20, 11, 40, 5, 862111)'}),
