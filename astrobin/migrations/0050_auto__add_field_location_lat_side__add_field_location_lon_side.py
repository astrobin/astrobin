...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.lat_side'
        db.add_column('astrobin_location', 'lat_side', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)

        # Adding field 'Location.lon_side'
        db.add_column('astrobin_location', 'lon_side', self.gf('django.db.models.fields.CharField')(default='E', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.lat_side'
        db.delete_column('astrobin_location', 'lat_side')

        # Deleting field 'Location.lon_side'
        db.delete_column('astrobin_location', 'lon_side')
