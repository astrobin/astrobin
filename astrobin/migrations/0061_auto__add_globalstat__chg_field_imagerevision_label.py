...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GlobalStat'
        db.create_table('astrobin_globalstat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('users', self.gf('django.db.models.fields.IntegerField')()),
            ('images', self.gf('django.db.models.fields.IntegerField')()),
            ('integration', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('astrobin', ['GlobalStat'])

        # Changing field 'ImageRevision.label'
        db.alter_column('astrobin_imagerevision', 'label', self.gf('django.db.models.fields.CharField')(max_length=1))


    def backwards(self, orm):
        
        # Deleting model 'GlobalStat'
        db.delete_table('astrobin_globalstat')

        # Changing field 'ImageRevision.label'
        db.alter_column('astrobin_imagerevision', 'label', self.gf('django.db.models.fields.CharField')(max_length=3))
