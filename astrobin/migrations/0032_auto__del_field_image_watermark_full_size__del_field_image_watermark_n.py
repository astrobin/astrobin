...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Image.watermark_full_size'
        db.delete_column('astrobin_image', 'watermark_full_size')

        # Deleting field 'Image.watermark_normal_size'
        db.delete_column('astrobin_image', 'watermark_normal_size')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Image.watermark_full_size'
        db.add_column('astrobin_image', 'watermark_full_size', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Image.watermark_normal_size'
        db.add_column('astrobin_image', 'watermark_normal_size', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
