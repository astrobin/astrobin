...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GearAssistedMerge'
        db.create_table('astrobin_gearassistedmerge', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['astrobin.Gear'])),
        ))
        db.send_create_signal('astrobin', ['GearAssistedMerge'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GearAssistedMerge'
        db.delete_table('astrobin_gearassistedmerge')
    ...
    models = {
        ...
        'astrobin.gear': {
            ...
            'assisted_merge': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['astrobin.GearAssistedMerge']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['astrobin.Gear']", 'null': 'True'})
        },
