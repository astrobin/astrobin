...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Camera.pixel_size'
        db.add_column('astrobin_camera', 'pixel_size', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Camera.sensor_width'
        db.add_column('astrobin_camera', 'sensor_width', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Camera.sensor_height'
        db.add_column('astrobin_camera', 'sensor_height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Camera.type'
        db.add_column('astrobin_camera', 'type', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Camera.pixel_size'
        db.delete_column('astrobin_camera', 'pixel_size')

        # Deleting field 'Camera.sensor_width'
        db.delete_column('astrobin_camera', 'sensor_width')

        # Deleting field 'Camera.sensor_height'
        db.delete_column('astrobin_camera', 'sensor_height')

        # Deleting field 'Camera.type'
        db.delete_column('astrobin_camera', 'type')
    ...
    models = {
        ...
        'astrobin.gear': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'make': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
