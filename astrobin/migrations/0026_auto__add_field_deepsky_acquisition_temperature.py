...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeepSky_Acquisition.temperature'
        db.add_column('astrobin_deepsky_acquisition', 'temperature', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeepSky_Acquisition.temperature'
        db.delete_column('astrobin_deepsky_acquisition', 'temperature')
