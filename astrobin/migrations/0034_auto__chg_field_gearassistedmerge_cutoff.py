...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GearAssistedMerge.cutoff'
        db.alter_column('astrobin_gearassistedmerge', 'cutoff', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'GearAssistedMerge.cutoff'
        db.alter_column('astrobin_gearassistedmerge', 'cutoff', self.gf('django.db.models.fields.IntegerField')())
