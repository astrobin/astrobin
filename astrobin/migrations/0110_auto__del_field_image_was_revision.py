...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Image.was_revision'
        db.delete_column('astrobin_image', 'was_revision')


    def backwards(self, orm):
        
        # Adding field 'Image.was_revision'
        db.add_column('astrobin_image', 'was_revision', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 9, 53, 53, 138815)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 9, 53, 53, 151167)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 9, 53, 53, 151087)'}),
