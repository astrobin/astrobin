...
class BroadcastEmailAdminRecoveredImagesNoticeItTest(TestCase):
    ...
    @patch("astrobin.tasks.send_broadcast_email.delay")
    def test_submit_recovered_images_notice_it_no_recovered_images(self, taskMock):
        request = RequestFactory().get("/")
    ...
    @patch("astrobin.tasks.send_broadcast_email.delay")
    def test_submit_recovered_images_notice_it_wrong_language(self, taskMock):
        request = RequestFactory().get("/")
    ...
    def test_submit_recovered_images_notice_it_sent(self, messageUserMock, taskMock):
        request = RequestFactory().get("/")
