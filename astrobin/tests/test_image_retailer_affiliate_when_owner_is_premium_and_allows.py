...
class ImageRetailerAffiliatesWhenOwnerIsPremiumAndAllowsTest(TestCase):
    def setUp(self) -> None:
        owner = Generators.user()
        self.owner_us = Generators.premium_subscription(owner, SubscriptionName.PREMIUM_CLASSIC)
