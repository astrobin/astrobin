...
urlpatterns = patterns('',
    ...
    url(r'^request/additional_information/(?P<image_id>\d+)/$', views.request_additional_information, name='request_additional_information'),
    url(r'^request/fits/(?P<image_id>\d+)/$', views.request_fits, name='request_fits'),
