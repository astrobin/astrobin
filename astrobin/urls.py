...
urlpatterns = patterns('',
    ...
    url(r'^help/rawdata/1/$', rawdata_views.Help1.as_view(), name='rawdata.help1'),
    url(r'^help/rawdata/2/$', rawdata_views.Help2.as_view(), name='rawdata.help2'),
    url(r'^help/rawdata/3/$', rawdata_views.Help3.as_view(), name='rawdata.help3'),
