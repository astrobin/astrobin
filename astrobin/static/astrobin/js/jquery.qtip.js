                ...
                // Check if mouse was the target
                    ...
                    event = (event && (event.type === 'resize' || event.type === 'scroll') ? cache.event :
                        event && event.pageX && event.type === 'mousemove' ? event :
                            MOUSE && MOUSE.pageX && (adjust.mouse || !event || !event.pageX) ? {
                                    pageX: MOUSE.pageX,
                                    pageY: MOUSE.pageY
                                } :
    ...
    function Ajax(api) {
        ...
        $.extend(self, {
            ...
            load: function (event) {
                ...
                xhr = $.ajax($.extend({success: successHandler, error: errorHandler, context: api}, opts, {
                    url: url,
                    complete: after
                }));
            },
    ...
    function Tip(qTip, command) {
        ...
        $.extend(self, {
            ...
            create: function () {
                ...
                elems.tip = $('<div />', {'class': 'ui-tooltip-tip'}).css({
                    width: width,
                    height: height
                }).prependTo(tooltip);
