...
def common_variables(request):
    ...
    d = {
        ...
        'PREMIUM_MAX_IMAGES_PREMIUM': settings.PREMIUM_MAX_IMAGES_PREMIUM,

        'PREMIUM_MAX_IMAGE_SIZE_FREE': settings.PREMIUM_MAX_IMAGE_SIZE_FREE,
        'PREMIUM_MAX_IMAGE_SIZE_LITE': settings.PREMIUM_MAX_IMAGE_SIZE_LITE,
        'PREMIUM_MAX_IMAGE_SIZE_PREMIUM': settings.PREMIUM_MAX_IMAGE_SIZE_PREMIUM,

        'PREMIUM_MAX_REVISIONS_FREE': settings.PREMIUM_MAX_REVISIONS_FREE,
        'PREMIUM_MAX_REVISIONS_LITE': settings.PREMIUM_MAX_REVISIONS_LITE,
        'PREMIUM_MAX_REVISIONS_PREMIUM': settings.PREMIUM_MAX_REVISIONS_PREMIUM,

        'PREMIUM_PRICE_FREE': settings.PREMIUM_PRICE_FREE,
        'PREMIUM_PRICE_LITE': settings.PREMIUM_PRICE_LITE,
        'PREMIUM_PRICE_PREMIUM': settings.PREMIUM_PRICE_PREMIUM,
        'PREMIUM_PRICE_ULTIMATE': settings.PREMIUM_PRICE_ULTIMATE,
