    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scale_units', models.CharField(blank=True, choices=[(b'degwidth', 'Width of the field in degrees'), (b'arcminwidth', 'Width of the field in arcminutes'), (b'arcsecperpix', 'Resolution of the field in arcseconds/pixel')], help_text=b'The units for the min/max field size settings below.', max_length=16, null=True, verbose_name='Field size units')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.PositiveIntegerField(choices=[(0, b'Missing'), (1, b'Pending'), (2, b'Failed'), (3, b'Success')], default=0)),
