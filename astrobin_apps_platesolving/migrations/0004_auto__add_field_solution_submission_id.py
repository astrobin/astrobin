...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Solution.submission_id'
        db.add_column('astrobin_apps_platesolving_solution', 'submission_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Solution.submission_id'
        db.delete_column('astrobin_apps_platesolving_solution', 'submission_id')
