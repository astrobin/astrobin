...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.date_updated'
        db.alter_column(u'astrobin_apps_groups_group', 'date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Group.date_created'
        db.alter_column(u'astrobin_apps_groups_group', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Group.date_updated'
        db.alter_column(u'astrobin_apps_groups_group', 'date_updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Group.date_created'
        db.alter_column(u'astrobin_apps_groups_group', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'astrobin_apps_groups.group': {
            'Meta': {'ordering': "['date_updated']", 'object_name': 'Group'},
