...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='group',
            name='category',
            field=models.CharField(choices=[('PROFESSIONAL_NETWORK', 'Professional network'),
                                            ('CLUB_OR_ASSOCIATION', 'Club or association'),
                                            ('INTERNET_COMMUNITY', 'Internet community'),
                                            ('FRIENDS_OR_PARTNERS', 'Friends or partners'),
                                            ('GEOGRAPHICAL_AREA', 'Geographical area'),
                                            ('AD_HOC_COLLABORATION', 'Ad-hoc collaboration'),
                                            ('SPECIFIC_TO_TECHNIQUE', 'Specific to an imaging technique'),
                                            ('SPECIFIC_TO_TARGET', 'Specific to an astrophotography target'),
                                            ('SPECIFIC_TO_EQUIPMENT', 'Specific to certain equipment'),
                                            ('OTHER', 'Other')], max_length=100, verbose_name='Category'),
        ),
