...
from astrobin_apps_groups.tasks import push_notification_for_group_join_request_rejection
    ...
    def post(self, request, *args, **kwargs):
        if request.is_ajax():
            ...
            try:
                ...
                logger.warning('GroupRejectJoinRequestView: user not found: %d' % user_pk)
                return Http404
            ...
            push_notification_for_group_join_request_rejection.apply_async(args=(group.pk, user.pk, request.user.pk))
