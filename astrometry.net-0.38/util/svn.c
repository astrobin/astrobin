...
static const char* date = "$Date: 2010-11-19 20:47:53 +0000 (Fri, 19 Nov 2010) $";
static const char* url  = "$HeadURL: svn+ssh://astrometry.net/svn/tags/tarball-0.38/astrometry/util/svn.c $";
static const char* rev  = "$Revision: 16745 $";
