...
// These are deprecated but still supported
    ...
    if ('undefined' === typeof ember_assert) {
        exports.ember_assert = Ember.K;
    }
    if ('undefined' === typeof ember_warn) {
        exports.ember_warn = Ember.K;
    }
    if ('undefined' === typeof ember_deprecate) {
        exports.ember_deprecate = Ember.K;
    }
    if ('undefined' === typeof ember_deprecateFunc) {
        exports.ember_deprecateFunc = function (_, func) {
            return func;
        };
    }
...
// meta system.
    ...
    function hasListeners(obj, eventName) {
        if (iterateSet(targetSetFor(obj, eventName), function () {
            return true;
        })) {
            return true;
        }
  ...
  // ...
    ...
    Ember.Application.registerInjection({
        ...
        injection: function (app, router, property) {
            ...
            if (!Ember.Object.detect(controllerClass)) {
                return;
            }
      ...
      context: App.Post.find()
        ...
        connectOutlet: function (name, context) {
            ...
            if (controller && context) {
                set(controller, 'content', context);
            }
    ...
    Ember.Routable = Ember.Mixin.create({
        ...
        routePath: function (manager, path) {
            ...
            var resolvedStates = this.resolvePath(manager, path),
                hasPromises = resolvedStates.some(function (s) {
                    return get(s, 'hasPromise');
                });

            function runTransition() {
                resolvedStates.forEach(function (rs) {
                    rs.transition();
                });
            }
            ...
            assignRouter: function (state, router) {
                ...
                if (childStates) {
                    for (var stateName in childStates) {
                        if (!childStates.hasOwnProperty(stateName)) {
                            continue;
                        }
...
// ==========================================================================
    ...
    (function (window) {
        ...
        var rangeFor, htmlFunc, removeFunc, outerHTMLFunc, appendToFunc, afterFunc, prependFunc, startTagFunc,
            endTagFunc;
