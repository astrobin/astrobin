...
class StripeWebhookServiceLiteOnceTest(TestCase):
    def setUp(self):
    ...
    def test_first_order(self):
        ...
        StripeWebhookService.process_event(e('lite_once_first_order/payment_intent.created'))
        StripeWebhookService.process_event(e('lite_once_first_order/customer.created'))
        StripeWebhookService.process_event(e('lite_once_first_order/payment_intent.succeeded'))
        StripeWebhookService.process_event(e('lite_once_first_order/charge.succeeded'))
        StripeWebhookService.process_event(e('lite_once_first_order/checkout.session.completed'))
    ...
    def test_renewal(self):
        ...
        user_subscription = Generators.premium_subscription(user, SubscriptionName.LITE_2020)
        ...
        StripeWebhookService.process_event(e('lite_once_renewal/payment_intent.created'))
        StripeWebhookService.process_event(e('lite_once_renewal/payment_intent.succeeded'))
        StripeWebhookService.process_event(e('lite_once_renewal/charge.succeeded'))
        StripeWebhookService.process_event(e('lite_once_renewal/checkout.session.completed'))
    ...
    def test_renewal_before_expiration(self):
        ...
        self.assertTrue(PremiumService.is_lite_2020(valid_subscription))
        self.assertEqual(
            valid_subscription.expires,
            extend_date_by(date.today() + timedelta(days=30), 1, 'Y')
        )
        self.assertTrue(valid_subscription.cancelled)
        self.assertEqual(valid_subscription.subscription, self.subscription)
