...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ThumbnailGroup'
        db.create_table('astrobin_apps_images_thumbnailgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='thumbnails', to=orm['astrobin.Image'])),
            ('real', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('real_inverted', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('hd', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('hd_inverted', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('regular', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('regular_inverted', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('gallery', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('gallery_inverted', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('thumb', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('revision', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('histogram', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('iotd', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('act_target', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('act_object', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
        ))
        db.send_create_signal('astrobin_apps_images', ['ThumbnailGroup'])

        # Adding unique constraint on 'ThumbnailGroup', fields ['image', 'revision']
        db.create_unique('astrobin_apps_images_thumbnailgroup', ['image_id', 'revision'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ThumbnailGroup', fields ['image', 'revision']
        db.delete_unique('astrobin_apps_images_thumbnailgroup', ['image_id', 'revision'])

        # Deleting model 'ThumbnailGroup'
        db.delete_table('astrobin_apps_images_thumbnailgroup')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 7, 19, 57, 23, 703801)'}),
        ...
        'astrobin.gear': {
            ...
            'commercial': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'base_gear'", 'null': 'True', 'to': "orm['astrobin.CommercialGear']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'astrobin_apps_images.thumbnailgroup': {
            ...
            'act_object': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'act_target': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 7, 19, 57, 23, 703055)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 7, 19, 57, 23, 702987)'}),
