...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThumbnailGroup.collection'
        db.add_column('astrobin_apps_images_thumbnailgroup', 'collection',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThumbnailGroup.collection'
        db.delete_column('astrobin_apps_images_thumbnailgroup', 'collection')
