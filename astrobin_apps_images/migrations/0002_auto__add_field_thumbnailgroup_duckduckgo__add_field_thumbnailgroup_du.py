...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ThumbnailGroup.duckduckgo'
        db.add_column('astrobin_apps_images_thumbnailgroup', 'duckduckgo', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)

        # Adding field 'ThumbnailGroup.duckduckgo_small'
        db.add_column('astrobin_apps_images_thumbnailgroup', 'duckduckgo_small', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ThumbnailGroup.duckduckgo'
        db.delete_column('astrobin_apps_images_thumbnailgroup', 'duckduckgo')

        # Deleting field 'ThumbnailGroup.duckduckgo_small'
        db.delete_column('astrobin_apps_images_thumbnailgroup', 'duckduckgo_small')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 29, 9, 28, 54, 409410)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 29, 9, 28, 54, 413342)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 29, 9, 28, 54, 413261)'}),
