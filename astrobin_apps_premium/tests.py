...
class PremiumTest(TestCase):
    ...
    def test_premium_get_usersubscription(self):
        with self.settings(PREMIUM_ENABLED=True):
            ...
            premium_us, created = UserSubscription.objects.get_or_create(user=u, subscription=premium_sub,
                                                                         cancelled=False)
            ...
            premium_autorenew_us, created = UserSubscription.objects.get_or_create(user=u,
                                                                                   subscription=premium_autorenew_sub,
                                                                                   cancelled=False)
            ...
            lite_autorenew_us, created = UserSubscription.objects.get_or_create(user=u, subscription=lite_autorenew_sub,
                                                                                cancelled=False)
