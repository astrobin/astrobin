...
urlpatterns = patterns('',
    ...
    url(r'^publicdatapools/(?P<pk>\d+)/remove-data/(?P<rawimage_pk>\d+)/$', login_required(PublicDataPoolRemoveDataView.as_view()), name = 'rawdata.publicdatapool_remove_data'),
    ...
    url(r'^privatesharedfolders/$', login_required(PrivateSharedFolderListView.as_view()), name = 'rawdata.privatesharedfolder_list'),
    url(r'^privatesharedfolders/(?P<pk>\d+)/$', login_required(PrivateSharedFolderDetailView.as_view()), name = 'rawdata.privatesharedfolder_detail'),
    ...
    url(r'^privatesharedfolders/(?P<pk>\d+)/remove-data/(?P<rawimage_pk>\d+)/$', login_required(PrivateSharedFolderRemoveDataView.as_view()), name = 'rawdata.privatesharedfolder_remove_data'),
    ...
    url(r'^privatesharedfolders/(?P<pk>\d+)/add-users/$', login_required(PrivateSharedFolderAddUsersView.as_view()), name = 'rawdata.privatesharedfolder_add_users'),
    url(r'^privatesharedfolders/(?P<pk>\d+)/remove-user/(?P<user_id>\d+)/$', login_required(PrivateSharedFolderRemoveUserView.as_view()), name = 'rawdata.privatesharedfolder_remove_user'),
