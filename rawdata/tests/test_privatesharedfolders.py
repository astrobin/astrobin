...
class PrivateSharedFolderTest(TransactionTestCase):
    ...
    def test_create_unsub(self):
        ...
        self.assertRedirects(
            ...
            reverse('rawdata.restricted') + '?' + urlencode(
                {'next': '/rawdata/privatesharedfolders/share/%d/' % rawimage_id}),
            status_code=302, target_status_code=200)
        self.client.logout()
    ...
    def test_delete_unsub(self):
        ...
        self.assertRedirects(
            response,
            reverse('rawdata.restricted') + '?' + urlencode(
                {'next': '/rawdata/privatesharedfolders/%d/delete/' % folder.id}),
            status_code=302, target_status_code=200)
    ...
    def test_add_data_unsub(self):
        ...
        self.assertRedirects(
            response,
            reverse('rawdata.restricted') + '?' + urlencode(
                {'next': '/rawdata/privatesharedfolders/%d/add-data/' % folder.id}),
            status_code=302, target_status_code=200)
        self.client.logout()
    ...
    def test_remove_data_anon(self):
        ...
        self.assertRedirects(
            response,
            'http://testserver/accounts/login/?next=/rawdata/privatesharedfolders/%d/remove-data/%d/' % (
                folder.id, rawimage_id),
            status_code=302, target_status_code=200)
    ...
    def test_remove_data_unsub(self):
        ...
        self.assertRedirects(
            response,
            reverse('rawdata.restricted') + '?' + urlencode(
                {'next': '/rawdata/privatesharedfolders/%d/remove-data/%d/' % (folder.id, rawimage_id)}),
            status_code=302, target_status_code=200)
        self.client.logout()
    ...
    def test_add_users_unsub(self):
        ...
        self.assertRedirects(
            response,
            reverse('rawdata.restricted') + '?' + urlencode(
                {'next': '/rawdata/privatesharedfolders/%d/add-users/' % folder.id}),
            status_code=302, target_status_code=200)
        self.client.logout()
    ...
    def test_remove_user_unsub(self):
        ...
        self.assertRedirects(
            response,
            reverse('rawdata.restricted') + '?' + urlencode(
                {'next': '/rawdata/privatesharedfolders/%d/remove-user/%d/' % (folder.id, self.subscribed_user_2.id)}),
            status_code=302, target_status_code=200)
        self.client.logout()
