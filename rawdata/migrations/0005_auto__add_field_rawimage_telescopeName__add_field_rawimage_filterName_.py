...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RawImage.telescopeName'
        db.add_column('rawdata_rawimage', 'telescopeName', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'RawImage.filterName'
        db.add_column('rawdata_rawimage', 'filterName', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'RawImage.subjectName'
        db.add_column('rawdata_rawimage', 'subjectName', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RawImage.telescopeName'
        db.delete_column('rawdata_rawimage', 'telescopeName')

        # Deleting field 'RawImage.filterName'
        db.delete_column('rawdata_rawimage', 'filterName')

        # Deleting field 'RawImage.subjectName'
        db.delete_column('rawdata_rawimage', 'subjectName')
    ...
    models = {
        ...
        'rawdata.rawimage': {
            ...
            'filterName': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'original_filename': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'original_path': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True'}),
            'size': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'subjectName': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'telescopeName': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
