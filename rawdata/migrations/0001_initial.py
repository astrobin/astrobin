    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='A name for this folder. Be descriptive, so that the folder can be quickly recognized by the name.', max_length=128, verbose_name='Name')),
                ('description', models.TextField(help_text='Describe the goals of this folder.', verbose_name='Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='A public name for this pool. Be descriptive, include the name of the celestial object and a target focal length in millimeters.', max_length=128, unique=True, verbose_name='Name')),
                ('description', models.TextField(help_text='Describe the goals and terms of this pool.', verbose_name='Description')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('active', models.BooleanField(default=True, editable=False)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(storage=django.core.files.storage.FileSystemStorage(location=b'/rawdata/files'), upload_to=rawdata.models.upload_path)),
                ...
                ('active', models.BooleanField(default=True, editable=False)),
                ('image_type', models.IntegerField(choices=[(0, 'Unknown'), (1, 'Light'), (2, 'Offset/Bias'), (3, 'Dark'), (4, 'Flat')], default=0, editable=False, max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(storage=django.core.files.storage.FileSystemStorage(location=b'/var/www'), upload_to=rawdata.models.temporary_download_upload_path)),
                ('size', models.IntegerField(default=0, editable=False)),
                ('created', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            ...
            name='archive',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='rawdata.TemporaryArchive'),
        ),
        migrations.AddField(
            model_name='publicdatapool',
            name='creator',
        ...
        migrations.AddField(
            model_name='privatesharedfolder',
            name='creator',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='privatesharedfolders_created', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='privatesharedfolder',
            name='images',
