...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RawImage'
        db.create_table('rawdata_rawimage', (
            ...
            ('image_type', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('acquisition_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('camera', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('temperature', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('rawdata', ['RawImage'])

        # Adding model 'TemporaryArchive'
        db.create_table('rawdata_temporaryarchive', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('size', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal('rawdata', ['TemporaryArchive'])

        # Adding model 'PublicDataPool'
        db.create_table('rawdata_publicdatapool', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('archive', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rawdata.TemporaryArchive'], null=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('rawdata', ['PublicDataPool'])

        # Adding M2M table for field images on 'PublicDataPool'
        db.create_table('rawdata_publicdatapool_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('publicdatapool', models.ForeignKey(orm['rawdata.publicdatapool'], null=False)),
            ('rawimage', models.ForeignKey(orm['rawdata.rawimage'], null=False))
        ))
        db.create_unique('rawdata_publicdatapool_images', ['publicdatapool_id', 'rawimage_id'])

        # Adding M2M table for field processed_images on 'PublicDataPool'
        db.create_table('rawdata_publicdatapool_processed_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('publicdatapool', models.ForeignKey(orm['rawdata.publicdatapool'], null=False)),
            ('image', models.ForeignKey(orm['astrobin.image'], null=False))
        ))
        db.create_unique('rawdata_publicdatapool_processed_images', ['publicdatapool_id', 'image_id'])

        # Adding model 'PrivateSharedFolder'
        db.create_table('rawdata_privatesharedfolder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='privatesharedfolders_created', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('archive', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rawdata.TemporaryArchive'], null=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('rawdata', ['PrivateSharedFolder'])

        # Adding M2M table for field users on 'PrivateSharedFolder'
        db.create_table('rawdata_privatesharedfolder_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('privatesharedfolder', models.ForeignKey(orm['rawdata.privatesharedfolder'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('rawdata_privatesharedfolder_users', ['privatesharedfolder_id', 'user_id'])

        # Adding M2M table for field images on 'PrivateSharedFolder'
        db.create_table('rawdata_privatesharedfolder_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('privatesharedfolder', models.ForeignKey(orm['rawdata.privatesharedfolder'], null=False)),
            ('rawimage', models.ForeignKey(orm['rawdata.rawimage'], null=False))
        ))
        db.create_unique('rawdata_privatesharedfolder_images', ['privatesharedfolder_id', 'rawimage_id'])

        # Adding M2M table for field processed_images on 'PrivateSharedFolder'
        db.create_table('rawdata_privatesharedfolder_processed_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('privatesharedfolder', models.ForeignKey(orm['rawdata.privatesharedfolder'], null=False)),
            ('image', models.ForeignKey(orm['astrobin.image'], null=False))
        ))
        db.create_unique('rawdata_privatesharedfolder_processed_images', ['privatesharedfolder_id', 'image_id'])


    def backwards(self, orm):
        
        # Deleting model 'RawImage'
        db.delete_table('rawdata_rawimage')

        # Deleting model 'TemporaryArchive'
        db.delete_table('rawdata_temporaryarchive')

        # Deleting model 'PublicDataPool'
        db.delete_table('rawdata_publicdatapool')

        # Removing M2M table for field images on 'PublicDataPool'
        db.delete_table('rawdata_publicdatapool_images')

        # Removing M2M table for field processed_images on 'PublicDataPool'
        db.delete_table('rawdata_publicdatapool_processed_images')

        # Deleting model 'PrivateSharedFolder'
        db.delete_table('rawdata_privatesharedfolder')

        # Removing M2M table for field users on 'PrivateSharedFolder'
        db.delete_table('rawdata_privatesharedfolder_users')

        # Removing M2M table for field images on 'PrivateSharedFolder'
        db.delete_table('rawdata_privatesharedfolder_images')

        # Removing M2M table for field processed_images on 'PrivateSharedFolder'
        db.delete_table('rawdata_privatesharedfolder_processed_images')
    ...
    models = {
        ...
        'rawdata.rawimage': {
            ...
            'acquisition_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'camera': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            ...
            'temperature': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uploaded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
