...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TemporaryArchive.ready'
        db.add_column('rawdata_temporaryarchive', 'ready', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TemporaryArchive.ready'
        db.delete_column('rawdata_temporaryarchive', 'ready')
