...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rawdata_rawimage', 'image_type', self.gf('django.db.models.fields.CharField')(default='U', max_length=1), keep_default=False)
    ...
    models = {
        ...
        'rawdata.rawimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_type': ('django.db.models.fields.CharField', [], {'default': "'U'", 'max_length': '1'}),
