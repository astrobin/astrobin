...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RawImage.original_path'
        db.add_column('rawdata_rawimage', 'original_path', self.gf('django.db.models.fields.CharField')(default='', max_length=512), keep_default=False)

        # Changing field 'RawImage.uploaded'
        db.alter_column('rawdata_rawimage', 'uploaded', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))


    def backwards(self, orm):
        
        # Deleting field 'RawImage.original_path'
        db.delete_column('rawdata_rawimage', 'original_path')

        # Changing field 'RawImage.uploaded'
        db.alter_column('rawdata_rawimage', 'uploaded', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None))
    ...
    models = {
        ...
        'rawdata.rawimage': {
            ...
            'original_path': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
