...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PublicDataPool.archive'
        db.add_column('rawdata_publicdatapool', 'archive', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PublicDataPool.archive'
        db.delete_column('rawdata_publicdatapool', 'archive')
    ...
    models = {
        ...
        'rawdata.publicdatapool': {
            ...
            'archive': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
