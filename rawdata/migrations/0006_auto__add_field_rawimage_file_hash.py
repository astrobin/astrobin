...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RawImage.file_hash'
        db.add_column('rawdata_rawimage', 'file_hash', self.gf('django.db.models.fields.CharField')(default='', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RawImage.file_hash'
        db.delete_column('rawdata_rawimage', 'file_hash')
    ...
    models = {
        ...
        'rawdata.rawimage': {
            ...
            'file_hash': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
