...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PublicDataPool.updated'
        db.add_column('rawdata_publicdatapool', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 12, 1), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PublicDataPool.updated'
        db.delete_column('rawdata_publicdatapool', 'updated')
