...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RawImage.file_hash'
        db.alter_column('rawdata_rawimage', 'file_hash', self.gf('django.db.models.fields.CharField')(max_length=32))


    def backwards(self, orm):
        
        # Changing field 'RawImage.file_hash'
        db.alter_column('rawdata_rawimage', 'file_hash', self.gf('django.db.models.fields.CharField')(max_length=16))
