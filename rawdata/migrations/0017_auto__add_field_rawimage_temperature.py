...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RawImage.temperature'
        db.add_column('rawdata_rawimage', 'temperature', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RawImage.temperature'
        db.delete_column('rawdata_rawimage', 'temperature')
