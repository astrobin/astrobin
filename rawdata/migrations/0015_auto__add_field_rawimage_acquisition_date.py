...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RawImage.acquisition_date'
        db.add_column('rawdata_rawimage', 'acquisition_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RawImage.acquisition_date'
        db.delete_column('rawdata_rawimage', 'acquisition_date')
