...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RawImage.original_filename'
        db.alter_column('rawdata_rawimage', 'original_filename', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'RawImage.original_path'
        db.alter_column('rawdata_rawimage', 'original_path', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))


    def backwards(self, orm):
        
        # Changing field 'RawImage.original_filename'
        db.alter_column('rawdata_rawimage', 'original_filename', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'RawImage.original_path'
        db.alter_column('rawdata_rawimage', 'original_path', self.gf('django.db.models.fields.CharField')(default='', max_length=512))
