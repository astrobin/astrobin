...
from astrobin_apps_users.views import (
    TogglePropertyUsersAjaxView, UserSearchView, BounceIgnoreAndRetryView,
    ComplaintRemove, BrevoWebhook,
)
...
urlpatterns = (
    ...
    url(
        r'brevo/webhook/$',
        never_cache(BrevoWebhook.as_view()),
        name='astrobin_apps_users.brevo_webhook',
    )
)
